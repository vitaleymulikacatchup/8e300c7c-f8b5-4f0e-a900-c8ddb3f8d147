...
export const metadata: Metadata = {
  title: "AP Wireless | Cell Tower Lease Buyouts & Investment Solutions",
  description: "Leading cell site lease investment firm. Get upfront lump-sum payments for your cell tower leases. 25+ years experience across 23 countries worldwide.",
  keywords: "cell tower lease buyout, cell site investment, wireless infrastructure, tower lease acquisition, property lease management",
  metadataBase: new URL("https://apwireless.com"),
  alternates: {
    canonical: "https://apwireless.com"
  },
  openGraph: {
    title: "AP Wireless | Strategic Cell Site Lease Investment",
    description: "Maximize your property's potential with upfront lump-sum payments for cell tower lease rights. Trusted by property owners across 23 countries.",
    siteName: "AP Wireless",
    type: "website",
    images: [{
      url: "https://images.pexels.com/photos/17324301/pexels-photo-17324301.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Cell phone tower communication infrastructure"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "AP Wireless | Cell Tower Lease Investment Solutions",
    description: "Get immediate capital for your cell site leases. 25+ years experience in wireless infrastructure investment.",
    images: ["https://images.pexels.com/photos/17324301/pexels-photo-17324301.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
